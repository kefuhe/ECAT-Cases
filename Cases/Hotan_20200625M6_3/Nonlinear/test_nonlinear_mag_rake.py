...
if __name__ == '__main__':
    ...
    basedir = '..'
    # 获取同震SAR数据
    varres_t034d = os.path.join(basedir, r'InSAR', 'downsample', 'S1_T165D_ifg')
    varres_t056a = os.path.join(basedir, r'InSAR', 'downsample', 'S1_T158A_ifg')

    coDscsar = insar('S1_T165D_ifg', lon0=lon0, lat0=lat0, verbose=verbose)
    coDscsar.read_from_varres(varres_t034d, cov=True)

    coAscsar = insar('S1_T158A_ifg', lon0=lon0, lat0=lat0, verbose=verbose)
