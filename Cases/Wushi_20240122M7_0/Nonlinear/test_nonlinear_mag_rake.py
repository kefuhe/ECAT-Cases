...
if __name__ == '__main__':
    ...
    basedir = '..'
    # 获取同震SAR数据
    varres_t034d = os.path.join(basedir, r'InSAR', 'downsample', 'S1T034D_ifg')
    varres_t056a = os.path.join(basedir, r'InSAR', 'downsample', 'S1T056A_ifg')
    ...
    if not args.no_plot:
        ...
        if rank == 0:
            # Plot the KDE matrix
            axis_labels = [r'$log(\sigma_{T034D}^2)$', r'$log(\sigma_{T056A}^2)$']
