...
def load_data(config, context):
    ...
    # unwphase_file = r'../geo_20220105_20220117.phs'
    # azi_file = r'../geo_20220105_20220117.azi'
    # inc_file = r'../geo_20220105_20220117.inc'
    sardata = GammasarReader('S1_T128A', lon0=101.25, lat0=37.75, directory_name='..')
    sardata.extract_raw_grd(prefix='geo_20220105_20220117')
    sardata.read_observation()
    return sardata, sardata.name
